...
public class UNH extends Segment {
    ...
    public class S009 extends Composite {
        ...
        @EdiElement(length = 6, mandatory = false)
        public String CodeListDirectoryVersioNumber_0110 = null;
        @EdiElement(length = 6, mandatory = false)
